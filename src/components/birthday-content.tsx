...
export default function BirthdayContent() {
  ...
  return (
    <div className="animate-in fade-in-50 duration-1000 space-y-8 sm:space-y-12 font-writing">
      ...
      <section>
        <h2 className="text-3xl sm:text-4xl font-bold text-primary/80 mb-6 flex items-center justify-center gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {galleryImages.map((image) => (
            <div key={image.id} className="group overflow-hidden rounded-lg shadow-lg aspect-w-1 aspect-h-1">
              <Image
                src={image.imageUrl}
      ...
      <section className="bg-primary/5 p-6 rounded-lg">
        <h2 className="text-3xl sm:text-4xl font-bold text-primary/80 mb-4 flex items-center justify-center gap-3">
          <CakeIcon className="h-8 w-8 text-accent" />
          A Special Wish
          <CakeIcon className="h-8 w-8 text-accent" />
        </h2>
